...
import logo from '../assets/lamassu_nav.png'
...
export default function Header() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#1A2820] border-b border-[#ddd8ce] shadow-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-28 items-center py-6 lg:py-10 justify-between">
          ...
          <Link to="/" className="flex items-center">
            <img src={logo} alt="Lamassu General Contracting" className="h-24 w-auto object-contain"/>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-8 font-medium">
            ...
            <div className="ml-10 flex flex-col gap-1 text-sm">
              <a href="tel:+16479216844" className="flex items-center gap-2 text-[#F7F5F0] hover:text-[#E07A5F]">
                {/* Phone SVG */}
              ...
              <a href="mailto:tolmassugc@gmail.com" className="flex items-center gap-2 text-[#F7F5F0] hover:text-[#E07A5F]">
                {/* Mail SVG */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden overflow-hidden transition-all duration-300 ${isOpen ? "max-h-125 opacity-100" : "max-h-0 opacity-0"}`}>
        <div className="bg-[#F7F5F0] border-t border-[#2B3E34]/20 px-6 py-6 space-y-4 text-center font-medium">
          ...
          <div className="pt-4 border-t space-y-3 text-sm">
            <a href="tel:+16479216844" className="flex justify-center items-center gap-2 text-[#4A4A4A]">
              {/* Phone SVG */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                <path d="M6.62 10.79a15.053 15.053 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.01-.24c1.12.37 2.33.57 3.57.57a1 1 0 0 1 1 1v3.5a1 1 0 0 1-1 1C10.07 22 2 13.93 2 3.5a1 1 0 0 1 1-1H6.5a1 1 0 0 1 1 1c0 1.24.2 2.45.57 3.57a1 1 0 0 1-.24 1.01l-2.2 2.21z" />
              </svg>
            ...
            <a href="mailto:tolmassugc@gmail.com" className="flex justify-center items-center gap-2 text-[#4A4A4A]">
              {/* Mail SVG */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z" />
              </svg>
